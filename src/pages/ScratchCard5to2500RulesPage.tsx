...
const ScratchCard5to2500RulesPage = () => {
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="bg-casino-header/50 border-b border-border p-4 flex items-center justify-between">
          <Button
            variant="ghost"
            size="icon"
            onClick={() => navigate('/raspadinha-5-para-2500')}
            className="h-8 w-8"
          >
            ...
            <CardContent className="p-4 space-y-6">
              <div>
                ...
                <div className="space-y-2 text-sm text-muted-foreground">
                  <p>• Compre uma cartela por R$ 5,00</p>
              ...
              <div>
                ...
                <div className="space-y-2 text-sm text-muted-foreground">
                  <p>• Com apenas R$ 5,00 você pode ganhar até R$ 2.500,00</p>
...
export default ScratchCard5to2500RulesPage;