...
const ScratchCard10to15000RulesPage = () => {
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="bg-casino-header/50 border-b border-border p-4 flex items-center justify-between">
          <Button
            variant="ghost"
            size="icon"
            onClick={() => navigate('/raspadinha-10-para-15000')}
            className="h-8 w-8"
          >
            ...
            <CardContent className="p-4 space-y-6">
              <div>
                ...
                <div className="space-y-2 text-sm text-muted-foreground">
                  <p>• Compre uma cartela por R$ 10,00</p>
              ...
              <div>
                ...
                <div className="space-y-2 text-sm text-muted-foreground">
                  <p>• Com apenas R$ 10,00 você pode ganhar até R$ 15.000,00</p>
...
export default ScratchCard10to15000RulesPage;