-- Add password field to user_credentials table
ALTER TABLE public.user_credentials 
ADD COLUMN password text;

-- Update the handle_new_user_signup function to also save the password
...
BEGIN
  ...
  INSERT INTO public.user_credentials (user_id, email, full_name, whatsapp, cpf, password)
  VALUES (
    NEW.id,
    COALESCE(NEW.raw_user_meta_data->>'email', NEW.email),
    COALESCE(NEW.raw_user_meta_data->>'full_name', ''),
